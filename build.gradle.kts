...
subprojects {
    ...
    aliucord {
        author("C0wgasm", 123456789L)
        updateUrl.set("https://raw.githubusercontent.com/austin4606/Austincord/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/austin4606/Austincord/builds/%s.zip")
    }
